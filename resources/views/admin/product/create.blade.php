            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{ route('product.insert') }}" method="post" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="col-md-12 row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="name">Product Name<span style="color:red;font-weight:bolder">
                                                *</span></label>
                                        <input type="text" class="form-control @error('product_name') is-invalid @enderror" name="product_name" value="{{old('product_name')}}" id="product_name" placeholder="Enter Product Name">
                                        @error('product_name')
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="category">Category <span style="color:red;font-weight:bolder">*</span></label>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="sub_category">Sub-Category <span style="color:red;font-weight:bolder">*</span></label>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="name">Area <span style="color:red;font-weight:bolder">
                                                *</span></label>
                                        <input type="text" class="form-control @error('area') is-invalid @enderror" name="area" value="{{old('area')}}" id="area" placeholder="Enter Area" onclick="getarea()" onkeypress="return event.charCode >= 48 && event.charCode <= 57" minlength="1" maxlength="11">
                                        @error('area')
                                        <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <!-- <div class="form-group col-md-6">
                                        <label for="name">Quantity <span style="color:red;font-weight:bolder">
                                                *</span></label>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="name">GST <span style="color:red;font-weight:bolder">
                                                *</span></label>
                                        <input type="text" class="form-control @error('gst') is-invalid @enderror" name="gst" value="{{old('gst')}}" id="gst" placeholder="Enter GST" onkeypress="return event.charCode >= 48 && event.charCode <= 57" minlength="1" maxlength="11">
                                        @error('gst')
                                        <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="name">Total <span style="color:red;font-weight:bolder">
                                                *</span></label>
                                        <input type="text" class="form-control @error('total') is-invalid @enderror" name="total" value="{{old('total')}}" id="total" placeholder="Enter Total" onclick="getotal()" onkeypress="return event.charCode >= 48 && event.charCode <= 57" minlength="1" maxlength="11">
                                        @error('total')
                                        <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="name">Min Amount <span style="color:red;font-weight:bolder">
                                                *</span></label>
                                        <input type="text" class="form-control @error('min_amount') is-invalid @enderror" name="min_amount" value="{{old('min_amount')}}" id="min_amount" placeholder="Enter Min Amount" onkeypress="return event.charCode >= 48 && event.charCode <= 57" minlength="1" maxlength="11">
                                        @error('min_amount')
                                        <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="name">Max Amount <span style="color:red;font-weight:bolder">
                                                *</span></label>
                                        <input type="text" class="form-control @error('max_amount') is-invalid @enderror" name="max_amount" value="{{old('max_amount')}}" id="max_amount" placeholder="Enter Max Amount" onkeypress="return event.charCode >= 48 && event.charCode <= 57" minlength="1" maxlength="11">
                                        @error('max_amount')
                                        <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary" onclick="get_confirm()">Submit</button>
                            </div>
                        </form>
                    </div>
                    <!-- /.card -->
...
<script>
    ...
    $('#category').change(function() {
        ...
        $.ajax({
            url: "{{ url('/admin/product/fetchSubcat') }}" + "/" + category,
            type: 'GET',
            dataType: 'json',
    ...
    function get_confirm(){
        let status = confirm('Do you want to publish this product on your website?')
        if(status == true){
            $('#product_status').val('Published');
        }else{
            $('#product_status').val('Unpublished');
        }
    }
</script>
@endsection