                        ...
                        <div class="card-body">
                            <div class="col-md-12 row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" disabled class="form-control @error('shop_name') is-invalid @enderror" name="shop_name" value="{{old('shop_name',$order[0]['shop_name'])}}" id="shop_name" placeholder="Enter Shop Name">
                                    @error('shop_name')
                                    <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    <label for="name">Order_Mode</label>
