            ...
            <div class="col-lg-6">
                <div class="hero-content rmb-55 wow fadeInUp delay-0-2s">
                    ...
                    <div class="hero-btns pt-25 wow fadeInUp delay-0-4s">
                        <a href="team.html" class="theme-btn">Talk With Us <i class="far fa-long-arrow-right"></i></a>
        ...
        <div class="row justify-content-center">
            <div class="col-xl-7 col-lg-8">
                <div class="section-title text-center mb-55 wow fadeInUp delay-0-2s">
                    ...
                    <h2>Best Subcategory For Printing</h2>
                </div>
            </div>
        </div>
        <div class="services-four-slider">
            @foreach($subcategorys as $subcategory)
            <div class="service-item-four wow fadeInUp delay-0-2s col-md-3">
                <div class="image">
                    <img src="{{url('uploads/subcategory/'.$subcategory->scat_img)}}" alt="Service" width="">
                </div>
                <div class="content">
                    <h4><a href="{{url('/subcategory/'.$subcategory->id)}}">{{$subcategory->sname}}</a></h4>
                    <span>Dispatch Time</span><p>{{$subcategory->dispatch_time}}</p>
                    <a href="{{url('/subcategory/'.$subcategory->id)}}" class="theme-btn style-three">Read More <i
                            class="far fa-long-arrow-right"></i></a>
                </div>
            </div>
            @endforeach
